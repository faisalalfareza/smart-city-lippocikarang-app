    ...
    function config($stateProvider, $cordovaFacebookProvider, $urlRouterProvider, $translateProvider, $sceDelegateProvider, $ionicConfigProvider, $ionicAppProvider) {
      ...
      $ionicConfigProvider.platform.android.views.maxCache(0);
        ...
        $translateProvider.translations('en', {
                ...
                taxi: 'Taxi',
                terms_privacy: 'I agree to Term of Use and Privacy Policy',
                ...
                stared_a_thread: 'STARTED A THREAD',
            ...
            .translations('ina', {
                app_name: 'LippoCikarang.com', //{{'app_name' | translate}}
                sound: 'Suara', //{{'app_name' | translate}}
                loading: 'Memuat', //{{'app_name' | translate}}
                Minimum_8_character: 'Minimal 8 karakter', //{{'app_name' | translate}}
                about: 'Tentang',
                ...
                supermarket: 'Supermarket',
                taxi: 'Taksi',
                terms_privacy: 'Saya Setuju dengan Syarat dan Ketentuan yang berlaku',
                ...
                cant_acces_billing: 'Tidak dapat mebuka tagihan',
                payment: 'Pembayaran',
